...
export default function AssignManagerForm({ isOpen, onClose, onSubmit, saving, branchName, error }) {
      ...
      <div className="w-full max-w-md bg-white rounded-2xl shadow-xl p-6">
        <div className="flex items-center justify-between mb-4">
          <h2 className="text-lg font-bold text-slate-900">
            Assign Manager{branchName ? ` — ${branchName}` : ""}
          </h2>
        ...
        <p className="text-xs text-gray-400 mb-4">
          {mode === "new"
            ? "This creates a new Branch Manager account for this branch."
            : "For someone who already signed up as a Branch Manager and isn't assigned to a branch yet. Enter the email they signed up with."}
        </p>
